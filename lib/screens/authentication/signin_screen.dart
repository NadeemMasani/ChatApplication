  ...
  signIn() async {
    if (formKey.currentState.validate()) {
      ...
      await auth
          ...
          .then((value) => {if (value != null) isAuthenticated = true});
      ...
      if (isAuthenticated) {
        ...
        Navigator.pushReplacement(context,
            MaterialPageRoute(builder: (context) => AppNavigator(user: user)));
      } else {
        setState(() {
          isLoading = false;
        });
        showAlertDialog(context, 'Invalid id or password', 'Alert');
      }
    }
  }
                    ...
                    children: [
                      ...
                      Center(
                        child: Row(
                          ...
                          children: [
                            Icon(Icons.chat,
                                color: Colors.blue.shade400, size: 45),
                            Text('Chit-Chat',
                                style: TextStyle(
                                    fontSize: 50,
                                    foreground: Paint()
